...
main (int argc, char *argv[])
{
  ...
  std::string tcp_variant = "TcpNewReno"; // Use TcpNewReno
  std::string bandwidth1 = "10Mbps";      // Bandwidth for N0 ↔ N1
  std::string bandwidth2 = "7Mbps";       // Bandwidth for N1 ↔ N2
  std::string delay1 = "100ms";           // Delay for N0 ↔ N1
  std::string delay2 = "10ms";            // Delay for N1 ↔ N2
  std::string queuesize = "50p";          // Queue size at N1
  double error_rate = 0.000001;           // Packet loss rate
  int simulation_time = 10;               // Simulation time in seconds
  ...
  pointToPoint1.SetDeviceAttribute ("DataRate", StringValue (bandwidth1));
  pointToPoint1.SetChannelAttribute ("Delay", StringValue (delay1));
  pointToPoint1.SetQueue ("ns3::DropTailQueue", "MaxSize", StringValue (queuesize));
  NetDeviceContainer devices1 = pointToPoint1.Install (n0n1);
  ...
  NetDeviceContainer devices2 = pointToPoint2.Install (n1n2);
  ...
  pointToPoint1.EnableAsciiAll (asciiTraceHelper.CreateFileStream ("tcp-example.tr"));
  pointToPoint1.EnablePcapAll ("tcp-example");
  pointToPoint2.EnablePcapAll ("tcp-example");
